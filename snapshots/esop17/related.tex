...
\gad{Fix reference to Vafeiadis thesis. We're incorrectly claiming his
  thesis did not present any semantics}
...
\gad{Fix reference w.r.t TaDa. R.1: `` It might be better to refine
