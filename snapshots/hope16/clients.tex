...
%ordering $\jleq{\ordlist}$ and how some individual events may be related in it,
%they \emph{do not} expose the actual definition of $\jleq{\ordlist}$ in terms of
%colors, or any other internal of the auxiliary state and code. Other
%snapshot implementations can provide their own definition of $\jleq{\ordlist}$.
