...
%% \paragraph*{Correctness of write and scan's specifications}%
...
\paragraph*{Correctness And Mechanization}%
...
%
% \ie the restriction of $\hist$ to the elements in the $\jleq{\ordlist}$ up to
